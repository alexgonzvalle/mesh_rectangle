...
from MeshStructured.coordinates import COORD, get_params_coords
from MeshStructured.interpolation import interpolate
from MeshStructured.utils import default_logger
from MeshStructured.plots import plot, plot_3d
...
class MeshStructured:
    ...
    def __init__(self, key, coord_type=COORD.UTM, name_logger='MeshStructured'):
    ...
    def read_conf(self, file_mesh_ini):
        ...
        if os.path.exists(file_mesh_ini):
            try:
                ...
                var_x, var_y, var_dx, var_dy, var_nx, var_ny = get_params_coords(self.coord_type)
    ...
    def execute(self, xb, yb, zb, x1=None, x2=None, y1=None, y2=None, dx=100, dy=100, file_mesh_ini=None, xc=None, yc=None, factor_select=1):
        ...
        :param dx: [int] Dx del primer de la malla.
        :param dy: [int] Dy del primer de la malla.
        :param file_mesh_ini: Archivo Mesh.ini.
        ...
        # Establecer malla
        self._set(x1, x2, y1, y2, dx, dy, file_mesh_ini)
        ...
        self.z = griddata((xb_s.ravel(), yb_s.ravel()), zb_s.ravel(), (self.x, self.y), method='linear')
    ...
    def get(self, file_mesh, x1=None, x2=None, y1=None, y2=None, dx=100, dy=100, file_mesh_ini=None):
    ...
    def plot(self, ax=None, fname_png=None, _show=True, dpi=300):
        ...
        return plot(self.x, self.y, self.z, self.coord_type, ax, fname_png, _show, dpi)

    def plot_3d(self, ax=None, fname_png=None, _show=True, dpi=300):
        ...
        return plot_3d(self.x, self.y, self.z, self.coord_type, ax, fname_png, _show, dpi)

    def interpolate(self, x, y, var):
        ...
        var_mesh = interpolate(x_mesh, y_mesh, x, y, var)
    ...
    # Helpers
    def _set(self, x1=None, x2=None, y1=None, y2=None, dx=100, dy=100, file_mesh_ini=None):
        """
        Cargar malla
        :param x1: Coordenada X del primer punto de la malla.
        :param x2: Coordenada X del segundo punto de la malla.
